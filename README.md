...
| Конфигурация | Ожидаемая точность |
|--------------|-------------------|
| Наша (32 нейрона, Tanh, Adam, 5 эпох) | ~68-70% |
| Оптимальная (256 нейронов, ReLU, Adam, 20 эпох) | ~89-90% |
| Полносвязная сеть с 2 слоями | ~87-88% |
| Простая свёрточная сеть (CNN) | ~91-92% |
| SOTA на FashionMNIST | ~95-96% |
